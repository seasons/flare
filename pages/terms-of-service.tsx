      ...
      <div className="privacypolicytext">
        <div className="div-block-2">
          <div className="text-block-10">
            ...
            products made available through our website(s) (each, a “Product”). Your rental or purchase of any Products
            will also be governed by any other terms made available by us to you during the rental or sales process, as
            applicable. If you have any questions, comments, or concerns regarding these terms or the Services, please
            contact us at:
            <br />
            <br />
            ...
            <strong>
              ...
              conditions (“Additional Terms”), which are incorporated herein by reference, and you understand and agree
            ...
            <strong>
              ...
              liability, a className action waiver and resolution of disputes by arbitration instead of in court. PLEASE
              NOTE THAT YOUR USE OF AND ACCESS TO OUR SERVICES ARE SUBJECT TO THE FOLLOWING TERMS; IF YOU DO NOT AGREE
            ...
            located at www.seasons.nyc, send you an email, and/or notify you by some other means.
            <br />
            <br />
            ...
            parental consent before they knowingly collect personally identifiable information online from children who
            are under thirteen (13). We do not knowingly collect or solicit personally identifiable information from
            children under thirteen (13); if you are a child under thirteen (13), please do not attempt to register for
            or otherwise use the Services or send us any personal information. If we learn we have collected personal
            information from a child under thirteen (13), we will delete that information as quickly as possible. If you
            believe that a child under thirteen (13) may have provided us personal information, please contact us at
            ...
            <br />
            <br />
            You will only use the Services and Products you obtain for your own internal, personal, non-commercial use,
            and not on behalf of or for the benefit of any third party, and only in a manner that complies with all laws
            that apply to you. If your use of the Services is prohibited by applicable laws, then you aren’t authorized
            to use the Services. We can’t and won’t be responsible for your using the Services in a way that breaks the
            law.
            <br />
            <br />
            You will not share your Seasons User ID, account or password with anyone, and you must protect the security
            of your Seasons User ID, account, password and any other access tools or credentials. You’re responsible for
            any activity associated with your Seasons User ID and account.
            <br />
            <br />
            <span>
            ...
            <strong>
              ...
              Seasons to send you information regarding your account or transactions with us, which may include Seasons
              using automated dialing technology to text you at the wireless number you provided, and you agree to
              receive communications from Seasons, and you represent and warrant that each person you register for the
              Services or for whom you provide a wireless phone number has consented to receive communications from
              Seasons.
            </strong>
            ...
            <br />
            (G) runs Maillist, Listserv, any form of auto-responder or “spam” on the Services, or any processes that run
            or are activated while you are not logged into the Services, or that otherwise interfere with the proper
            working of the Services (including by placing an unreasonable load on the Services’ infrastructure) ;<br />
            ...
            text, graphics, data, articles, photos, images, illustrations, User Submissions (as defined below) and so
            ...
            owner of that Content or (ii) in a way that violates someone else’s (including Seasons&#x27;) rights.Subject
            to these Terms, we grant each user of the Services a worldwide, non-exclusive, non-sublicensable and
            ...
            than using the Services is expressly prohibited without prior written permission from us. You understand
            that Seasons owns the Services. You won’t modify, publish, transmit, participate in the transfer or sale of,
            ...
            accurate, complete, up-to-date, and in compliance with all applicable laws, rules and regulations. You agree
            that you will not post, upload, share, store, or otherwise provide through the Services any User Submissions
            that: (i) infringe any third party&#x27;s copyrights or other rights (e.g., trademark, privacy rights,
            etc.); (ii) contain sexually explicit content or pornography; (iii) contain hateful, defamatory, or
            ...
            gambling, cash gifting, work from home businesses, or any other dubious money-making ventures; or (viii)
            ...
            all of this site or the Services (and derivative works thereof) in any media formats and through any media
            channels (including, without limitation, third party websites and feeds), and including after your
            ...
            rights in your User Submissions, including the right to grant additional licenses to your User Submissions,
            unless otherwise agreed in writing. You represent and warrant that you have all rights to grant such
            licenses to us without infringement or violation of any third party rights, including without limitation,
            any privacy rights, publicity rights, copyrights, trademarks, contract rights, or any other intellectual
            property or proprietary rights.Finally, you understand and agree that Seasons, in performing the required
            technical steps to provide the Services to our users (including you), may need to make changes to your User
            Submissions to conform and adapt those User Submissions to the technical requirements of connection
            networks, devices, services, or media, and the foregoing licenses include the rights to do so.
            <br />
            <br />
            <span>
              ‍
            ...
            Copyright Dispute Policy and learn how to report potentially infringing content, click here.
            <br />
            <br />
            <span>
            ...
            third-party site or service. We encourage you to be aware when you leave the Services and to read the terms
            and conditions and privacy policy of each third-party website or service that you visit or utilize. By using
            the Services, you release and hold us harmless from any and all liability arising from your use of any
            third-party website or service .<br />
            <br />
            ...
            transaction with any of these third parties. You agree that Seasons shall not be responsible or liable for
            ...
            you agree that Seasons is under no obligation to become involved. In the event that you have a dispute with
            one or more other users, you release Seasons, its directors, officers, employees, agents, and successors
            from claims, demands, and damages of every kind or nature, known or unknown, suspected or unsuspected,
            disclosed or undisclosed, arising out of or in any way related to such disputes and/or our Services. You
            shall and hereby do waive California Civil Code Section 1542 or any similar law of any jurisdiction, which
            says in substance: “A general release does not extend to claims that the creditor or releasing party does
            ...
            Services that would adversely affect you, but this isn’t always practical. We reserve the right to remove
            any Products or Content from the Services at any time, for any reason (including, but not limited to, if
            ...
            and all such charges, fees or costs are your sole responsibility. You should consult with your wireless
            ...
            subject to the terms, conditions and privacy policies of the Payment Processors in addition to these Terms.
            Currently, we use Stripe, Inc. and Chargebee Inc. as our Payment Processor. You can access Stripe’s Terms of
            Service at <a href="https://stripe.com/us/checkout/legal">https://stripe.com/us/checkout/legal</a> and
            Stripe’s Privacy Policy at <a href="https://stripe.com/us/privacy">https://stripe.com/us/privacy</a>. You
            can access Chargebee’s Terms of Service at{" "}
            <a href="https://www.chargebee.com/company/terms/">https://www.chargebee.com/company/terms/</a> and
            Chargebee’s Privacy Policy at{" "}
            <a href="https://www.chargebee.com/privacy/">https://www.chargebee.com/privacy/</a>. We are not responsible
            for any error by, or other acts or omissions of, the Payment Processors. By choosing to purchase a
            membership with us, you agree to pay us, through the Payment Processors, all charges at the prices then in
            effect for such membership in accordance with the applicable payment terms, and you authorize us, through
            the Payment Processors, to charge your chosen payment provider (your “Payment Method”). You agree to make
            payment using that selected Payment Method. We reserve the right to correct any errors or mistakes that the
            Payment Processors make even if it has already requested or received payment.
            <br />
            <br />
            ...
            Payment Method. If we, through the Payment Processors, do not receive payment from you, you agree to pay all
            amounts due on your Billing Account upon demand.
            <br />
            <br />
            C. Recurring Billing. Use of our Services requires purchase of a membership, consisting of an initial period
            for which there is a one-time charge, followed by recurring period charges thereafter based on the
            ...
            MUST PROMPTLY NOTIFY US OR OUR PAYMENT PROCESSORS IF YOUR PAYMENT METHOD IS CANCELED (E.G., FOR LOSS OR
            ...
            SUBSCRIPTIONS UNDER YOUR BILLING ACCOUNT UNLESS YOU HAVE TERMINATED YOUR PAID SUBSCRIPTIONS AS SET FORTH
            ABOVE.
            <br />
            <br />
            E. Change in Amount Authorized. If the amount to be charged to your Billing Account varies from the amount
            you preauthorized (other than due to the imposition or change in the amount of state sales taxes), you have
            the right to receive, and we shall provide, notice of the amount to be charged and the date of the charge
            before the scheduled date of the transaction. Any agreement you have with your payment provider will govern
            your use of your Payment Method. You agree that we may accumulate charges incurred and submit them as one or
            more aggregate charges, including during or at the end of each billing cycle.
            <br />
            <br />
            ...
            then-current non-promotional rate. To change or resign your Paid Subscription(s) at any time, go to account
            settings.  If you terminate a Paid Subscription, you may use your subscription until the end of your
            then-current term, and your subscription will not be renewed after your then-current term expires. However,
            you will not be eligible for a prorated refund of any portion of the subscription fee paid for the
            then-current subscription period. If you do not want to continue to be charged on a recurring monthly basis,
            you must cancel the applicable Paid subscription through your account settings or terminate your SEASONS
            account before the end of the recurring TERM. Paid subscriptions cannot be terminated before the end of the
            period for which you have already paid, and except as expressly provided in these terms, SEASONS will not
            ...
            that we are authorized to charge your Payment Method for that Paid Subscription. We may submit those charges
            for payment and you will be responsible for such charges. This does not waive our right to seek payment
            directly from you. Your charges may be payable in advance, in arrears, per usage, or as otherwise described
            when you initially selected to use the Paid Subscription.
            <br />
            <br />
            <span>
            ...
            reason in our discretion, including your breach of these Terms. Seasons has the sole right to decide whether
            ...
            <br />
            <br />
            If you have deleted your account by mistake, contact us immediately at membership@seasons.nyc – we will try
            to help, but unfortunately, we can’t promise that we can recover or restore anything.
            <br />
            <br />
            ...
            <br />
            <br />
            (a) Both you and Seasons acknowledge that the Terms are concluded between you and Seasons only, and not with
            ...
            will be deemed to have accepted the right) to enforce these Terms against you as the third-party beneficiary
            hereof.
            <strong className="bodyheader">
              <br />
              <br />
            ...
            From time to time Seasons may offer rewards or incentives for referring others to the Services. For details
            of any current referral offers, please see our referral page. The referring user (“Referrer”) may refer
            individuals or entities who are neither current customers of Seasons nor registered users of the Services
            (“Referee”). A registered user is a person or entity that already has an existing account with Seasons.
            There is no limit to the number of referrals that Referrer can make, nor the cumulative rewards or
            incentives that the Referrer may receive through such special offer, unless otherwise indicated. Referrer
            will receive the stated reward or incentive for each Referee sent by the Referrer that completes the
            required action described in that specific offer (such as signing up for an account or making a purchase).
            All Referees must be first-time recipients of the offer, and multiple referrals to the same individual or
            entity will be disregarded. Seasons reserves the right to modify or terminate any special offers at any time
            and to revoke from Referrer and Referee the special offer at Seasons&#x27; discretion for any reason or for
            no reason whatsoever. If Seasons determines that Referrer or Referee is attempting to obtain unfair
            advantage or otherwise violate the terms or spirit of such special offer, Seasons reserves the right to (a)
            revoke any rewards or incentives issued to either Referrer or Referee and/or (b) charge the Referrer or
            Referee for any rewards or incentives (1) used by Referrer or Referee prior to such revocation or (2) issued
            by Seasons to any ineligible Referrer or Referee. All special offers are subject to any other terms,
            conditions and restrictions set forth on the Services or presented in connection with the special offer.
            <strong className="bodyheader">
              <br />
              <br />
            ...
            contract employees, representatives and agents, and each of their respective successors and assigns (Seasons
            and all such parties together, the “Seasons Parties”) make no representations or warranties concerning the
            Services, including without limitation regarding any Content contained in or accessed through the Services
            or any Products, and the Seasons Parties will not be responsible or liable for the accuracy, copyright
            compliance, legality, or decency of material contained in or accessed through the Services or any claims,
            actions, suits procedures, costs, expenses, damages or liabilities arising out of use of, or in any way
            related to your participation in, the Services. The Seasons Parties make no representations or warranties
            regarding suggestions or recommendations of services or products offered or purchased through or in
            connection with the Services including, without limitation, any Products. Products and services purchased or
            offered (whether or not following such recommendations and suggestions) through the Services are provided
            “AS-IS” and without any warranty of any kind from the Seasons Parties or others (unless, with respect to
            such others only, provided expressly and unambiguously in writing by a designated third party for a specific
            product). THE SERVICES AND CONTENT ARE PROVIDED BY SEASONS (AND ITS LICENSORS AND SUPPLIERS) ON AN “AS-IS”
            BASIS, WITHOUT WARRANTIES OF ANY KIND, EITHER EXPRESS OR IMPLIED, INCLUDING, WITHOUT LIMITATION, IMPLIED
            WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, NON-INFRINGEMENT, OR THAT USE OF THE
            SERVICES WILL BE UNINTERRUPTED OR ERROR-FREE. SOME STATES DO NOT ALLOW LIMITATIONS ON HOW LONG AN IMPLIED
            WARRANTY LASTS, SO THE ABOVE LIMITATIONS MAY NOT APPLY TO YOU.
            <br />
            <br />‍<em>Limitation of Liability</em>. TO THE FULLEST EXTENT ALLOWED BY APPLICABLE LAW, UNDER NO
            CIRCUMSTANCES AND UNDER NO LEGAL THEORY (INCLUDING, WITHOUT LIMITATION, TORT, CONTRACT, STRICT LIABILITY, OR
            OTHERWISE) SHALL ANY OF THE SEASONS PARTIES BE LIABLE TO YOU OR TO ANY OTHER PERSON FOR (A) ANY INDIRECT,
            SPECIAL, INCIDENTAL, PUNITIVE OR CONSEQUENTIAL DAMAGES OF ANY KIND, INCLUDING DAMAGES FOR LOST PROFITS,
            BUSINESS INTERRUPTION, LOSS OF DATA, LOSS OF GOODWILL, WORK STOPPAGE, ACCURACY OF RESULTS, OR COMPUTER
            FAILURE OR MALFUNCTION, (B) ANY SUBSTITUTE GOODS, SERVICES OR TECHNOLOGY, (C) ANY AMOUNT, IN THE AGGREGATE,
            IN EXCESS OF THE GREATER OF (I) ONE-HUNDRED ($100) DOLLARS OR (II) THE AMOUNTS PAID AND/OR PAYABLE BY YOU TO
            SEASONS IN CONNECTION WITH THE SERVICES IN THE TWELVE (12) MONTH PERIOD PRECEDING THIS APPLICABLE CLAIM OR
            (D) ANY MATTER BEYOND OUR REASONABLE CONTROL. SOME STATES DO NOT ALLOW THE EXCLUSION OR LIMITATION OF
            INCIDENTAL OR CONSEQUENTIAL OR CERTAIN OTHER DAMAGES, SO THE ABOVE LIMITATION AND EXCLUSIONS MAY NOT APPLY
            TO YOU.
            <br />
            <br />‍<em>Indemnity</em>. You agree to indemnify and hold the Seasons Parties harmless from and against any
            and all claims, liabilities, damages (actual and consequential), losses and expenses (including attorneys’
            fees) arising from or in any way related to any claims relating to (a) your use of the Services (including
            any actions taken by a third party using your account) and any Products, and (b) your violation of these
            Terms.
            <br />
            <br />
            ...
            <br />
            <br />‍<em>Arbitration Agreement. </em>Please read the following ARBITRATION AGREEMENT carefully because it
            requires you to arbitrate certain disputes and claims with Seasons and limits the manner in which you can
            seek relief from Seasons. Both you and Seasons acknowledge and agree that for the purposes of any dispute
            arising out of or relating to the subject matter of these Terms, Seasons&#x27; officers, directors,
            employees and independent contractors (“Personnel”) are third-party beneficiaries of these Terms, and that
            upon your acceptance of these Terms, Personnel will have the right (and will be deemed to have accepted the
            ...
            accordance with such Rules. Judgment upon the award rendered by such arbitrator may be entered in any court
            of competent jurisdiction.
            <br />
            <br />
            (b) <em>Costs of Arbitration</em>. The Rules will govern payment of all arbitration fees. Seasons will pay
            all arbitration fees for claims less than seventy-five thousand ($75,000) dollars. Seasons will not seek its
            attorneys’ fees and costs in arbitration unless the arbitrator determines that your claim is frivolous.
            <br />
            <br />
            (c) <em>Small Claims Court; Infringement</em>. Either you or Seasons may assert claims, if they qualify, in
            small claims court in New York County, New York or any United States county where you live or work.
            Furthermore, notwithstanding the foregoing obligation to arbitrate disputes, each party shall have the right
            to pursue injunctive or other equitable relief at any time, from any court of competent jurisdiction, to
            prevent the actual or threatened infringement, misappropriation or violation of a party&#x27;s copyrights,
            ...
            COURT AND HAVE A TRIAL IN FRONT OF A JUDGE OR JURY. You and Seasons are instead choosing to have claims and
            disputes resolved by arbitration. Arbitration procedures are typically more limited, more efficient, and
            less costly than rules applicable in court and are subject to very limited review by a court. In any
            ...
            THOSE OF ANY OTHER CUSTOMER OR USER. If however, this waiver of className or consolidated actions is deemed
            invalid or unenforceable, neither you nor Seasons is entitled to arbitration; instead all claims and
            ...
            apply to either party, and both you and Seasons agree that any judicial proceeding (other than small claims
            actions) will be brought in the state or federal courts located in, respectively, New York County, New York,
            ...
            Arbitration Agreement section will be null and void. This arbitration agreement will survive the termination
            of your relationship with Seasons.
            <br />
            ...
            that these Terms shall otherwise remain in full force and effect and enforceable. You and Seasons agree that
            these Terms are the complete and exclusive statement of the mutual understanding between you and Seasons,
            and that these Terms supersede and cancel all previous written and oral agreements, communications and other
            understandings relating to the subject matter of these Terms. You hereby acknowledge and agree that you are
            not an employee, agent, partner, or joint venture of Seasons, and you do not have any authority of any kind
            to bind Seasons in any respect whatsoever.
            <br />
            <br />
