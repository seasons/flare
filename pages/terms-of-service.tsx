        ...
        <div className="privacypolicytext">
          <div className="div-block-2">
            <div className="text-block-10">
              ...
              provisions in this document as well as those in the <a href="privacy-policy.html">Privacy Policy</a>,{" "}
              ...
              click <a href="privacy-policy.html">here</a>.
              <br />
              <br />‍
              ...
              <a href="privacy-policy.html">Privacy Policy</a> to the extent they relate to User Submissions that are
              ...
              You may choose to rent or purchase Products through the www.seasons.nyc website or our mobile
              applications. Seasons may limit or cancel quantities of Products rented or purchased, and it reserves the
              right to refuse any order. In the event Seasons needs to make a change to an order, it will attempt to
              notify you by contacting the email address, billing address, and/or phone number provided at the time the
              order was made. The prices displayed are quoted in U.S. currency and are valid only in the United States.
              Prices are subject to change at any time. Sales tax will be determined by the shipping address of the
              order and will automatically be added to the order. Seasons is required by law to apply sales tax to
              orders to certain states. Rented or purchased Products will be shipped to the shipping address of the
              order. Information about our shipping rates and return policy can all be found on our{" "}
              <a href="index.html">Frequently Asked Questions</a> page.  Any payment terms presented to you in the
              ...
              <a href="privacy-policy.html">Privacy Policy</a>, as well as the licenses above, to understand how we
