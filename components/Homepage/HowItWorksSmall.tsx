...
const ITEMS = [
  {
    ...
    text: "Love something? Buy it. We’ll apply your $20 membership fee as a discount once a month.",
  },
  {
    icon: <BillingIcon />,
    title: "Flexible pricing",
    text: "Each item has a 30-day rental price with a 12 day minimum. After that, we’ll pro-rate daily.",
  },
  {
    icon: <CalendarIcon />,
    title: "New styles every week",
    text: "We launch new styles every week and restock every Tuesday and Thursday.",
  },
]
